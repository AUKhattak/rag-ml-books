...
class TextCleaner:
    ...
    def clean_text(self, text: str, fix_spaces: bool = True, 
                   fix_encoding: bool = True, fix_math: bool = True,
    ...
    def clean_ml_artifacts(self, text: str) -> str:
        ...
        text = re.sub(r'(Chapter|Section|Equation|Figure|Table|Algorithm)\s+([0-9]+)\s+([0-9]+)', 
                     r'\1 \2.\3', text)  # Section 5 3 -> Section 5.3
